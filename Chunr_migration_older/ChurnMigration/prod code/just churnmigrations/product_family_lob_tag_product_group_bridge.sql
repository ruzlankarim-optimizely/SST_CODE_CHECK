...
-- Date: Jan 24, 2024
-- Time: 4:54:06 PM
-- Product Family tag & LOB product group bridge
CREATE TABLE ryzlan.sst_product_bridge_product_family_Tag_lob_CM AS
SELECT *
FROM ryzlan.sst_product_bridge_product_family_Tag_CM
LIMIT 3 TRUNCATE TABLE ryzlan.sst_product_bridge_product_family_Tag_lob_CM;
ALTER TABLE ryzlan.sst_product_bridge_product_family_Tag_lob_CM
ADD current_lob VARCHAR(255);
ALTER TABLE ryzlan.sst_product_bridge_product_family_Tag_lob_CM
ADD prior_lob VARCHAR(255);
create or replace function ryzlan.sp_populate_product_family_TAG_lob_churn_migration(var_period text) returns void language plpgsql as $$ BEGIN
DELETE from ryzlan.sst_product_bridge_product_family_Tag_lob_CM
...
INSERT INTO ryzlan.sst_product_bridge_product_family_Tag_lob_CM (
    evaluation_period,
    prior_period,
    current_period,
...
update ryzlan.sst_product_bridge_product_family_Tag_lob_CM a
...
update ryzlan.sst_product_bridge_product_family_Tag_lob_CM
...
where product_bridge = 'Up Sell'
  ...
  and evaluation_period = var_period;
END;
$$ TRUNCATE TABLE ryzlan.sst_product_bridge_product_family_Tag_lob_CM
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2019M01');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2019M02');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2019M03');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2019M04');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2019M05');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2019M06');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2019M07');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2019M08');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2019M09');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2019M10');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2019M11');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2019M12');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2020M01');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2020M02');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2020M03');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2020M04');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2020M05');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2020M06');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2020M07');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2020M08');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2020M09');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2020M10');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2020M11');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2020M12');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2021M01');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2021M02');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2021M03');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2021M04');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2021M05');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2021M06');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2021M07');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2021M08');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2021M09');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2021M10');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2021M11');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2021M12');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2022M01');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2022M02');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2022M03');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2022M04');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2022M05');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2022M06');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2022M07');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2022M08');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2022M09');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2022M10');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2022M11');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2022M12');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2023M01');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2023M02');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2023M03');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2023M04');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2023M05');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2023M06');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2023M07');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2023M08');
select ryzlan.sp_populate_product_family_TAG_lob_churn_migration('2023M09');