create or replace function sandbox_pd.sp_populate_sst_product_bridge_product_solution(var_period text, run_acquire_customers int) returns void language plpgsql as $$ BEGIN
...
from sandbox_pd.sst_product_bridge_product_solution a
  ...
  and a.evaluation_period = b.evaluation_period
  and a.current_product_solution = b.current_product_group
  left join sandbox_pd.sst_product_bridge_product_solution c on c.mcid = a.mcid
...
delete from sandbox_pd.sst_product_bridge_product_solution a using temp_windowngrade_final_curated b
where 1 = 1
  and a.mcid = b.mcid
  and a.evaluation_period = b.evaluation_period
...
from sandbox_pd.sst_product_bridge_product_solution a
  ...
  join sandbox_pd.sst_product_bridge_product_solution c on c.mcid = b.mcid
...
where b.Split_record = 1
  ...
  and a.product_bridge in ('Downgrade', 'Churn', 'Downsell')
order by mcid;
delete from sandbox_pd.sst_product_bridge_product_solution a using temp_CPI_Reversal b
where 1 = 1
  and a.mcid = b.mcid
  and a.evaluation_period = b.evaluation_period
  and coalesce(
...
where b.Split_record = 1
  ...
  and a.product_bridge in ('Downgrade', 'Downsell')
order by mcid;
delete from sandbox_pd.sst_product_bridge_product_solution a using temp_upselldowngrade_final b
where 1 = 1
  and a.mcid = b.mcid
  and a.evaluation_period = b.evaluation_period
  and a.current_product_solution = b.product_group_downgrade
