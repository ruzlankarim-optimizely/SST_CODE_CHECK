-- PRODUCT GROUP PRODUCT SOLUTION BRIDGE

create or replace function ryzlan.sp_populate_product_group_churn_migration_cloud(var_period text) returns void
    language plpgsql
as
$$
...
BEGIN
    ...
    DELETE from ryzlan.sst_product_bridge_product_group_CM_cloud
    ...
    SELECT snapshot_date,
           ...
           temp_product_solution_li as product_solution,
    ...
    SELECT
        ...
        cla.current_product_group as current_product_group,
        cla.prior_product_group as prior_product_group,
    ...
    with temp as
             (
                 select b.snapshot_date
                      , b.mcid
                      , b.temp_product_solution_li as product_solution
                      ...
                      , row_number() over (partition by b.mcid,b.temp_product_group_li order by b.snapshot_date desc) as rnk
                 from arr_new_products_tmp a
                          join (select
                               ...
                               on a.mcid = b.mcid
                                   ...
                                   and a.product_solution = b.temp_product_solution_li
    ...
    INSERT INTO ryzlan.sst_product_bridge_product_group_CM_cloud
    (
        evaluation_period,
        prior_period,
        current_period,
...
--         "name",
    ...
    update ryzlan.sst_product_bridge_product_group_CM_cloud a
    ...
    update ryzlan.sst_product_bridge_product_group_CM_cloud
...
TRUNCATE TABLE ryzlan.sst_product_bridge_product_group_CM_cloud

select ryzlan.sp_populate_product_group_churn_migration_cloud('2019M01');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2019M02');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2019M03');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2019M04');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2019M05');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2019M06');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2019M07');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2019M08');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2019M09');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2019M10');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2019M11');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2019M12');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2020M01');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2020M02');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2020M03');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2020M04');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2020M05');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2020M06');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2020M07');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2020M08');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2020M09');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2020M10');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2020M11');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2020M12');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2021M01');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2021M02');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2021M03');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2021M04');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2021M05');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2021M06');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2021M07');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2021M08');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2021M09');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2021M10');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2021M11');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2021M12');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2022M01');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2022M02');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2022M03');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2022M04');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2022M05');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2022M06');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2022M07');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2022M08');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2022M09');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2022M10');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2022M11');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2022M12');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2023M01');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2023M02');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2023M03');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2023M04');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2023M05');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2023M06');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2023M07');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2023M08');
select ryzlan.sp_populate_product_group_churn_migration_cloud('2023M09');