DROP TABLE IF EXISTS sandbox.sst_customer_bridge_rollover_cm_core;
CREATE TABLE sandbox.sst_customer_bridge_rollover_cm_core AS
SELECT *
FROM ufdm_archive.sst_customer_bridge_core_lcoked_17122024_0238 scb;
...
create table sandbox.customer_churn_migration_default_cases as
    ...
    from sandbox.sst_customer_bridge_rollover_cm_core    as a
...
Delete from sandbox.sst_customer_bridge_rollover_cm_core as a
...
Insert into sandbox.sst_customer_bridge_rollover_cm_core as a (
evaluation_period,
    prior_period,
    current_period,
...
GROUP BY 1,
  ...
  12,
  13;
TRUNCATE TABLE sandbox.sst_customer_bridge_rollover_cm_core;
INSERT INTO sandbox.sst_customer_bridge_rollover_cm_core(
    evaluation_period,
    prior_period,
    current_period,
    current_master_customer_id,
