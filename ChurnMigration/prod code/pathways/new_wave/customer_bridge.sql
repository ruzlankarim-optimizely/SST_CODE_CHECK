create or replace function sandbox_pd.sp_populate_sst_customer_bridge(var_period text) returns void language plpgsql as $$ BEGIN RAISE NOTICE 'Running sst_customer_bridge for %...',
  var_period;
...
from sandbox_pd.sst_customer_bridge a
  join temp_windowngrade_final_curated b on a.mcid = b.mcid
  and a.evaluation_period = b.evaluation_period --left join sandbox_pd.sst_customer_bridge c on c.mcid = a.mcid and c.evaluation_period = a.evaluation_period and c.customer_bridge = 'Up Sell'
where b.Split_record = 1
...
delete from sandbox_pd.sst_customer_bridge a using temp_windowngrade_final_curated b
where 1 = 1
  and a.mcid = b.mcid
  and a.evaluation_period = b.evaluation_period
  and b.Split_record = 1
...
where b.Split_record = 1
  ...
  and a.customer_bridge <> 'Flat'
order by mcid;
delete from sandbox_pd.sst_customer_bridge a using temp_cpi_reversal_final_curated b
where 1 = 1
  and a.mcid = b.mcid
  and a.evaluation_period = b.evaluation_period
  and b.Split_record = 1
...
delete from sandbox_pd.sst_customer_bridge a using temp_cross_upsell_reversal_final_curated b
where 1 = 1
  and a.mcid = b.mcid
  and a.evaluation_period = b.evaluation_period
  and b.Split_record = 1
