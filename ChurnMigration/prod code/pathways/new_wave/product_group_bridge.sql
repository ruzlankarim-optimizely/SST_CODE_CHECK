create or replace function sandbox_pd.sp_populate_sst_product_bridge_product_group(var_period text, run_acquire_customers int) returns void language plpgsql as $$ BEGIN
...
SELECT snapshot_date,
  ...
  case
    when coalesce(run_acquire_customers, 0) = 1 then acquire_product_group
...
temp2 as (
  ...
  from sandbox_pd.sst_product_bridge_product_group b
...
from sandbox_pd.sst_product_bridge_product_group a
  ...
  and a.evaluation_period = b.evaluation_period
  and a.current_product_group = b.current_product_group
  left join sandbox_pd.sst_product_bridge_product_group c on c.mcid = a.mcid
...
/*
 ...
 join sandbox_pd.sst_product_bridge_product_group c on c.mcid = b.mcid and c.evaluation_period = b.Downgrade_evaluation_period and c.current_product_group = b.current_product_group
...
delete from sandbox_pd.sst_product_bridge_product_group a using temp_windowngrade_final_curated b
where 1 = 1
  and a.mcid = b.mcid
  and a.evaluation_period = b.evaluation_period
...
from sandbox_pd.sst_product_bridge_product_group a
  ...
  left join (
    ...
    from sandbox_pd.sst_product_bridge_product_group suba
...
from sandbox_pd.sst_product_bridge_product_group a
  ...
  and a.evaluation_period = b.evaluation_period
  and coalesce(a.current_product_group, a.prior_product_group) = b.current_product_group
  join sandbox_pd.sst_product_bridge_product_group c on c.mcid = b.mcid
...
where b.Split_record = 1
  ...
  and a.product_bridge in ('Downgrade', 'Churn', 'Downsell')
order by mcid;
delete from sandbox_pd.sst_product_bridge_product_group a using temp_CPI_Reversal b
where 1 = 1
  and a.mcid = b.mcid
  and a.evaluation_period = b.evaluation_period
  and coalesce(a.current_product_group, a.prior_product_group) = b.current_product_group
...
where b.Split_record = 1
  ...
  and a.product_bridge in ('Downgrade', 'Downsell', 'churn')
order by mcid;
delete from sandbox_pd.sst_product_bridge_product_group a using temp_upselldowngrade_final b
where 1 = 1
  and a.mcid = b.mcid
  and a.evaluation_period = b.evaluation_period
  and a.current_product_group = b.product_group_downgrade
...
TRUNCATE table sandbox_pd.sst_product_bridge_product_group ;
