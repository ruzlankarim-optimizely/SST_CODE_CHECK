...
SELECT *
FROM sandbox_tmjs.sst_product_bridge_product_group_cloud_license_temp ;
...
--     and it3.mcid =  '7183df70-0c08-e511-9afb-0050568d2da8'
-- 	and it3.evaluation_period = '2025M03'
  ) --  SELECT
,
  initial_table_5 as (
    select *,
