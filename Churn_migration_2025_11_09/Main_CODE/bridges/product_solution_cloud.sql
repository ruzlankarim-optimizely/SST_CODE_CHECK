...
SELECT *
FROM sandbox_tmjs.sst_product_bridge_product_solution_cloud_license_temp
;



drop table if exists ryzlan.temp_pg_bridge;
create  table ryzlan.temp_pg_bridge as
    select
    evaluation_period,
    mcid,
    currency_code ,
...
where 1 = 1
--  and mcid = 'b9b22eb7-8843-e611-8145-c4346bad81ec'
-- 	and evaluation_period = '2024M07'

-- and product_bridge ilike '%- migration'
;

drop table if exists ryzlan.temp_ps_bridge;
create  table ryzlan.temp_ps_bridge as
    Select
        a.evaluation_period ,
        a.mcid ,
        a.currency_code,
    ...
    join (select evaluation_period, mcid , currency_code  from ryzlan.temp_pg_bridge group by 1,2,3) as b
...
--  and a.mcid  = 'b9b22eb7-8843-e611-8145-c4346bad81ec'
-- 	and a.evaluation_period = '2024M07'
;
...
-- where mcid = 'b9b22eb7-8843-e611-8145-c4346bad81ec'
-- 	and evaluation_period = '2024M07'
...
select
    ...
    a.product_arr_change_ccfx,
    a.product_arr_change_lcu
from ryzlan.temp_pg_bridge as a
...
left join ryzlan.temp_ps_bridge as b
on a.evaluation_period = b.evaluation_period
and a.mcid = b.mcid
and a.currency_code = b.currency_code
...
--    select * from ryzlan.temp_ps_bridge
--    where mcid = '50661331-d24e-e811-813c-70106fa6f451'
-- 	and evaluation_period = '2024M04';
