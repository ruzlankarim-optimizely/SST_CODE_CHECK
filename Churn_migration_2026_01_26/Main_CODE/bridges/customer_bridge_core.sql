...
SELECT *
FROM ufdm_archive.sst_customer_bridge_core_temp_lcoked_20260204_1855
    scb;
...
with    base_product_group AS (
  ...
  FROM sandbox.sst_product_solution_bridge_rollup_cm_cloud
    where current_product_solution   in ('AI', 'Experience Creation', 'Experience Optimization')
    or prior_product_solution  in ('AI', 'Experience Creation', 'Experience Optimization')
),
