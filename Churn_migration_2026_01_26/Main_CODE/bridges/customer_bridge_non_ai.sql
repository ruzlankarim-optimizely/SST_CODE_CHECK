...
SELECT *
FROM ufdm_archive.sst_customer_bridge_non_ai_temp_lcoked_20260204_1855 
...
with    base_product_group AS (
  ...
  where current_product_solution   in ('Experience Creation', 'Experience Optimization', 'EOL', 'Other', 'License')
    or prior_product_solution  in ('Experience Creation', 'Experience Optimization', 'EOL', 'Other', 'License')
),
