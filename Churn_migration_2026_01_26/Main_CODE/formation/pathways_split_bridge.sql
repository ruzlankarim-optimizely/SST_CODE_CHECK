...
CREATE TEMP TABLE sst_temp AS
    ...
    ELSE 'USUAL'
  END AS pathways
FROM  ryzlan.sst_adhoc as a
left join ryzlan.tmjs_05_02_2026  as b
...
Insert Into ryzlan.sst_product_pathways_bridge_split
select *
...
BEGIN
    ...
    while exists(select 1 from temp_snapshots) loop
            ...
            PERFORM  ryzlan.sp_populate_sst_product_pathway_split(evaluation_period_input);
