...
-- create table sandbox.sst_product_group_bridge_cloud_older as select * from sandbox.sst_product_group_bridge_cloud;
...
----
-- select * from churn_migration_classifiers_pg ;
...
--     and it3.mcid = '03c56cf3-c42c-e411-9f63-0050568d2da8'
-- 	and it3.evaluation_period = '2019M12'
  ) --  SELECT
,
  initial_table_5 as (
    select *,
