CREATE OR REPLACE FUNCTION ryzlan.sp_populate_sst_product_bridge_product_group_reversal_fix(var_period text) RETURNS void LANGUAGE plpgsql AS $function$ BEGIN
