DROP TABLE IF EXISTS sandbox.churn_migration_classifiers_ending_arr;
create table sandbox.churn_migration_classifiers_ending_arr as (
  with initial_table as (
    select *,
      current_pathways as current_product_family_class,
      prior_pathways as prior_product_family_class
    from ryzlan.sst_product_pathways_bridge_ending_arr
  ),
  initial_table_2 as (
    select *,
