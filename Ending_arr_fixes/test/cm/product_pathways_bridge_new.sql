create or replace function ryzlan.sp_populate_sst_product_pathways_ending_arr(var_period text) returns void language plpgsql as $$ BEGIN
DELETE from ryzlan.sst_product_pathways_bridge_ending_arr
...
where product_bridge = 'Up Sell'
  ...
  and evaluation_period = var_period;
Insert Into ryzlan.sst_product_pathways_bridge_ending_arr
select *
from arr_product_bridge_tmp;
END;
$$ 