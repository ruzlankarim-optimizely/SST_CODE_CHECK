CREATE OR REPLACE FUNCTION sandbox_pd.sp_ufdm_sst_updates_manual() RETURNS void LANGUAGE plpgsql AS $function$ BEGIN --take a backup into archive db for comparison before and after
  --remove fopti duplicates
  perform sandbox_pd.sp_ufdm_remove_fopti_dups_sst_manual();
...
--select snapshot_date,arr,baseline_arr_local_currency,cohort_actions,product_family from sandbox_pd.sst where mcid= '8ef0bf48-f16c-72ce-6356-41f25b5aaaf2' and snapshot_date between '2022-09-30' and '2023-07-31' and arr > 0
update sandbox_pd.sst
set arr = '218333.33',
...
set product_family = 'Recurring: Cloud: Commerce Cloud: B2B Commerce (incl. Headless)',
  modified_comments = 'Updated product family from blank' --select product_family,* from sandbox_pd.sst
