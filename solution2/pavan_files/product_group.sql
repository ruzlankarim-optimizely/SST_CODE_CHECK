CREATE OR REPLACE FUNCTION sandbox_pd.sp_populate_sst_product_bridge_product_group(var_period text) RETURNS void LANGUAGE plpgsql AS $function$ BEGIN
...
INSERT INTO sandbox_pd.sst_product_bridge_product_group (
    evaluation_period,
    prior_period,
    current_period,
...
update sandbox_pd.sst_product_bridge_product_group a
...
update sandbox_pd.sst_product_bridge_product_group
