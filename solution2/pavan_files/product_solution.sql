CREATE OR REPLACE FUNCTION sandbox_pd.sp_populate_sst_product_bridge_product_solution(var_period text) RETURNS void LANGUAGE plpgsql AS $function$ BEGIN
...
SELECT snapshot_date,
  ...
  new_product_solution as product_family,
...
create temp table arr_churned_products_tmp AS with temp as (
  select b.snapshot_date,
    b.mcid,
    b.new_product_solution as product_family,
    a.baseline_currency,
  ...
  from arr_new_products_tmp a
    ...
    and a.product_family = b.new_product_solution
