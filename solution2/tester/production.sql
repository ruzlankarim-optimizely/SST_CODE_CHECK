create or replace function public.sp_populate_sst_product_bridge(var_period text) returns void language plpgsql as $$ BEGIN
DELETE from ufdm.sst_product_bridge
...
create temp table arr_churned_products_tmp AS with temp as (
  ...
  from arr_new_products_tmp a
    join ufdm.sst b on a.mcid = b.mcid
...
INSERT INTO ufdm.sst_product_bridge (
    evaluation_period,
    prior_period,
    current_period,
...
update ufdm.sst_product_bridge a
...
update ufdm.sst_product_bridge
...
from ufdm.sst_product_bridge a
